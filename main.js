        ...
        if (data.logged_in) {
            ...
            navButtonsContainers.forEach(container => {
                ...
                profileBtn.onclick = () => {
                    ...
                    if (data.role === 'mbg') window.location.href = ABS('dashboard/mbg.php');
                    else if (data.role === 'sekolah') window.location.href = ABS('dashboard/sekolah.php');
                    else if (data.role === 'ortu') window.location.href = ABS('dashboard/orangtua.php');
                    else if (data.role === 'siswa') window.location.href = ABS('dashboard/siswa.php');
                };
